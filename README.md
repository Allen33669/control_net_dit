...
<body>
<h3>Licensed under the Apache License, Version 2.0 (the "License"); # you may not use this file except in compliance with the License. # You may obtain a copy of the License at # # http://www.apache.org/licenses/LICENSE-2.0 # # Unless required by applicable law or agreed to in writing, software # distributed under the License is distributed on an "AS IS" BASIS, # WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. # See the License for the specific language governing permissions and # limitations under the License.</h3>
...
<h5>(https://github.com/lllyasviel/controlnet), licensed under the Apache License Version 2.0.</h3>
<h5>(https://github.com/facebookresearch/DiT), licensed under the Attribution-NonCommercial 4.0 International.</h3>
<br>
<h3>paper:</h3>
<h5>Adding Conditional Control to Text-to-Image Diffusion Models https://arxiv.org/abs/2302.05543.</h3>
<h5>Scalable Diffusion Models with Transformers https://arxiv.org/abs/2212.09748.</h3>
<br>
<h3>Optuna:</h3>
<h5>@inproceedings{akiba2019optuna, title={{O}ptuna: A Next-Generation Hyperparameter Optimization Framework}, author={Akiba, Takuya and Sano, Shotaro and Yanase, Toshihiko and Ohta, Takeru and Koyama, Masanori}, booktitle={The 25th ACM SIGKDD International Conference on Knowledge Discovery & Data Mining}, pages={2623--2631}, year={2019} }</h3>
<h5>License:</h3>
<h5>MIT License (see LICENSE).</h3>
<h5>Optuna uses the codes from SciPy and fdlibm projects (see LICENSE_THIRD_PARTY).</h3>
<br>
<h3>captum:</h3>
<h5>License:</h3>
<h5>Captum is BSD licensed, as found in the LICENSE file.</h3>
<br>
<h3>Rectified Flow:</h3>
<h5>paper: https://arxiv.org/abs/2209.03003</h3>
<h5>github: https://github.com/gnobitab/RectifiedFlow</h3>
<br>
<h3>lora:</h3>
<h5>github: https://github.com/cloneofsimo/lora</h3>
<br>
<br>
<br>
<br>
...
<h3>2.1.0: </h3>
<h5>  application_control_net_dit_lora_rectified_flow.html (only article):</h5>
<h5>    Application with ControlNet, Dit, Rectified Flow, and lora. Describe the usages and steps.</h5>
<br>
<h3>2.0.0: </h3>
