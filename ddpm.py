...
class DDPM(pl.LightningModule):
    ...
    def lime_image(self, input_hint_flatten):
        self.lime_samples_image_x.append(input_hint_flatten)
        input = self.lime_sample
        input_hint = input_hint_flatten.view(input['hint'].shape)
        input['hint'] = input_hint
        loss = self.training_step(input, 0)
        self.lime_samples_image_y.append(loss)
        return loss

    def lime_text_0_1(self, input_text_0_1):
        self.lime_samples_text_x.append(input_text_0_1)
        ...
        input_text_new = ''
        for i, value in enumerate(input_text_0_1.squeeze(0)):
          if value == 1:
            input_text_new = input_text_new + input_text_words[i] + ' '
